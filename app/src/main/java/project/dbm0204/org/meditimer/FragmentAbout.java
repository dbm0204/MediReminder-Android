...
public class FragmentAbout extends Fragment {
  ...
  @OnClick(R.id.aboutContact) public void onClick() {
    ...
    try {
      ...
      Toast.makeText(getActivity(), getString(R.string.about_intent_failed), Toast.LENGTH_LONG)
          .show();
    }
  }
  ...
  private void setSpans() {
    ...
    text1.setSpan(new RelativeSizeSpan(1.5f), 23, 31, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
    ...
    text1.setSpan(new RelativeSizeSpan(1.5f), text1.length() - 20, text1.length() - 9,
        Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
    text1.setSpan(new ForegroundColorSpan(getResources().getColor(R.color.material_blue)), 23, 31,
        Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
    text1.setSpan(new ForegroundColorSpan(getResources().getColor(R.color.material_blue)),
        text1.length() - 45, text1.length() - 29, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
    text1.setSpan(new ForegroundColorSpan(getResources().getColor(R.color.material_blue)),
        text1.length() - 20, text1.length() - 9, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
    text1.setSpan(new StyleSpan(Typeface.BOLD_ITALIC), 23, 31, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
    ...
    text2.setSpan(new RelativeSizeSpan(1.5f), 24, text2.length() - 10,
        Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
    text2.setSpan(new ForegroundColorSpan(getResources().getColor(R.color.material_blue)), 24,
